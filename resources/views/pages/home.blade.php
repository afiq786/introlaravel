...
@section('content')
<div class="flex justify-center items-center bg-slate-800 min-h-screen w-full">
    <div class="relative cursor-pointer dark:text-white">
        ...
        <div
            ...
            <div class="flex items-center">
                <h3 class="my-2 text-4xl font-bold text-gray-800 dark:text-white text-center">HOMEPAGE</h3>
            </div>
        </div>
    </div>
</div>
