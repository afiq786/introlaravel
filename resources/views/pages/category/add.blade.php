...
@section('content')
    <section class="mb-8">
        <h2 class="text-4xl tracking-tight text-shadow-md font-bold text-center">Add Category</h2>
    </section>

    <section class="flex justify-center w-screen">
        <form action="/category" method="POST" class="bg-slate-800 shadow-lg rounded-lg px-8 py-8 mb-4 min-w-4xl">
            @csrf
            <div class="mb-4">
