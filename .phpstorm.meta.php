...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\config(), map([
            ...
            'filesystems.links./srv/http/introlaravel/public/storage' => 'string',
...
'filesystems.disks.s3.report','filesystems.links./srv/http/introlaravel/public/storage','logging.default','logging.deprecations.channel','logging.deprecations.trace',
...
'layouts.footer','layouts.master','layouts.navbar','pages.about','pages.addProduct',
'pages.contact','pages.home','pages.product','laravel-exceptions-renderer::components.badge','laravel-exceptions-renderer::components.empty-state',
